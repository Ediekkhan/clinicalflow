...
export default defineConfig({
  ...
  webServer: [
    { command: '../.venv/bin/python -m uvicorn app.main:app --host 127.0.0.1 --port 8100', cwd: '../backend', env: { APP_ENV: 'test', AUTH_RATE_LIMIT: '1000', AUTH_COOKIE_SECURE: 'true', ENABLE_TEST_FIXTURES: 'true', ENABLE_DEMO_CONTENT: 'true', AUTO_CREATE_SCHEMA: 'true', SKIP_PHONE_VERIFICATION: 'true', DATABASE_URL: browserTestDatabase, CORS_ORIGINS: 'http://127.0.0.1:3100' }, url: 'http://127.0.0.1:8100/health', reuseExistingServer: false, timeout: 120_000 },
