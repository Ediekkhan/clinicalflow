...
export default defineConfig({
  ...
  webServer: [
    { command: 'python -m uvicorn app.main:app --host 127.0.0.1 --port 8100', cwd: '../backend', env: { APP_ENV: 'test', ENABLE_TEST_FIXTURES: 'true', AUTO_CREATE_SCHEMA: 'true', DATABASE_URL: browserTestDatabase, CORS_ORIGINS: 'http://127.0.0.1:3100' }, url: 'http://127.0.0.1:8100/health', reuseExistingServer: false, timeout: 120_000 },
