  ...
  return (
    <HospitalShell>
      ...
      <main className="mx-auto grid max-w-7xl gap-5 p-4 md:p-6">
        <div>
          <p className="text-sm font-bold uppercase tracking-wider text-[#60706a]">Doctor View</p>
          <h1 className="font-display text-4xl text-[#10231e] md:text-5xl">Patients assigned to me</h1>
