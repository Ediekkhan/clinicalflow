  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#0D1117] p-4 text-white md:p-6">
      <section className="grid w-full max-w-6xl gap-8 text-center">
        <div>
          <p className="text-sm font-bold uppercase tracking-wider text-emerald-300">Hospital Waiting Room</p>
        ...
        <div className="rounded-card border border-white/10 bg-white/5 p-6 md:p-10">
          ...
          <p className="mt-6 text-3xl font-bold tracking-tight text-emerald-300 sm:text-4xl md:text-6xl">IN {room.toUpperCase()}</p>
        </div>
