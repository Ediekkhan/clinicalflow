...
export default function LogoutPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#0D1117] p-4 text-white">
      <section className="w-full max-w-md rounded-2xl border border-white/10 bg-white p-6 text-center text-slate-900 shadow-xl">
        <div className="mx-auto grid h-12 w-12 place-items-center rounded-full bg-blue-50 text-[#2563EB]">
