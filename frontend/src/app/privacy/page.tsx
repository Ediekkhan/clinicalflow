...
const sections = [
  {
    ...
    text: 'ClinicalFlow treats health data as sensitive personal data and keeps consent, purpose limitation, access control, and audit logging at the center of the platform.',
  },
  {
    id: 'cookie-policy',
    title: 'Cookie Policy',
  ...
  },
  {
    ...
    text: 'Partner facilities remain controllers of their patient records while ClinicalFlow processes data only to provide triage, scheduling, queue, and coordination services.',
  },
];
    ...
    <main className="min-h-screen bg-[#f7f9fc] text-[#020b22]">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20 pt-32">
        ...
        <p className="mt-4 max-w-2xl text-lg leading-8 text-[#60706a]">
          This page explains how ClinicalFlow protects patient, provider, and facility data across the healthcare network.
        </p>
